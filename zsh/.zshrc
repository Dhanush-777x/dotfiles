...
alias r='ranger'
alias fzfnv='nvim "$(find . /mnt/3462937862933E14/ -type f | fzf -m --preview="bat --color=always {}")"'
alias fzfd='nvim "$(find /mnt/3462937862933E14/ -type f | fzf -m --preview="bat --color=always {}")"'
alias ranger='ranger /mnt/3462937862933E14/'
alias tmux="tmux -u"
