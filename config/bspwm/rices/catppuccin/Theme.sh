...
BORDER_WIDTH="2" P_FADE="true" P_SHADOWS="true" P_CORNER_R="6" SHADOW_C="#000000"

# (Catppuccin Mocha Lavendar) colorscheme
bg="#1e1e2e" fg="#b4befe"

black="#15161e" red="#f38ba8" green="#a6e3a1" yellow="#f9e2af"
blackb="#414868" redb="#f38ba8" greenb="#a6e3a1" yellowb="#f9e2af"

blue="#b4befe" magenta="#bb9af7" cyan="#7dcfff" white="#a9b1d6"
...
launch_theme() {
  ...
  feh --no-fehbg --bg-fill "${HOME}"/.config/bspwm/rices/"${RICE}"/walls/wall-01.png
